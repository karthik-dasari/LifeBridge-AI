  ...
  return (
    <section className="bg-white rounded-xl shadow-md p-6 space-y-4" aria-label="AI Analysis Results">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <p className="text-xs text-gray-700 uppercase tracking-wide" id="emergency-type-label">Emergency Type</p>
          <p className="text-lg font-bold text-gray-900 capitalize" aria-labelledby="emergency-type-label">{analysis.emergency_type}</p>
        </div>
        <div>
          <p className="text-xs text-gray-700 uppercase tracking-wide" id="severity-label">Severity</p>
        ...
        <div>
          <p className="text-xs text-gray-700 uppercase tracking-wide" id="confidence-label">Confidence</p>
        ...
        <div>
          <p className="text-xs text-gray-700 uppercase tracking-wide">Required Facilities</p>
